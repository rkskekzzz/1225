...
export default function EditCalendarPage() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const saveResponse = await fetch(`/api/calendars/${calendarId}`, {
        method: "PUT",
        headers: {
      ...
      const url = `${baseUrl}/users/${userId}/calendars/${calendarId}`;
      setShareUrl(url);
          ...
          <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-slate-600 hover:text-slate-800 transition-colors font-medium"
              >
